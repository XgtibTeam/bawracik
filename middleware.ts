...
const STAFF_PROTECTED_API: { prefix: string; methods: string[]; roles: Role[] }[] = [
  ...
  { prefix: '/api/products', methods: ['POST'], roles: ['superadmin', 'admin', 'kasir'] },
  { prefix: '/api/products', methods: ['DELETE', 'PUT'], roles: ['superadmin', 'admin'] },
  ...
  { prefix: '/api/reports/daily', methods: ['GET'], roles: ['superadmin', 'admin', 'kasir'] },
  { prefix: '/api/reports/daily-export', methods: ['GET'], roles: ['superadmin', 'admin', 'kasir'] },
  { prefix: '/api/reports/susulan', methods: ['GET'], roles: ['superadmin', 'admin'] },
  { prefix: '/api/stock-topup', methods: ['POST'], roles: ['superadmin', 'admin', 'kasir'] },
...
export const config = {
  matcher: [
    ...
    '/api/reports/daily/:path*',
    '/api/reports/daily-export/:path*',
    '/api/reports/susulan/:path*',
    '/api/stock-topup/:path*',
