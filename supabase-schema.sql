...
create table if not exists transactions (
  ...
  voucher_code text,
  susulan boolean not null default false, -- true kalau ini input SUSULAN (lupa dicatat di tanggal kejadian, baru diinput belakangan lewat toggle "Input Susulan" di /kasir)
...
-- MIGRASI (kalau tabel transactions sudah ada dari sebelumnya di Supabase
-- kamu, `create table if not exists` di atas TIDAK akan menambah kolom baru
...
-- ============================================================
-- (Outing Stock table dihapus — sekarang pakai "Susulan": transactions
-- biasa dengan created_at di-backdate + kolom susulan=true di bawah.)
-- ============================================================
