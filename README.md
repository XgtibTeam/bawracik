...
|---|---|
| Teks/master data (profil toko, cabang, karyawan, produk, harga, member, voucher) | **JSONBin.io** |
| Transaksi & rekap stok (data yang terus bertambah) | **Supabase** (database) |
| Foto (swafoto absensi, foto produk) | **Google Drive** |
...
lib/
  ...
  jsonbin.ts               → akses JSONBin (teks/master data)
  supabase.ts              → akses Supabase (transaksi & rekap stok)
  google-drive.ts          → upload/list foto (2 folder: attendance & products)
